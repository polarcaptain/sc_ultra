...
export default function SSPage() {
  const [ssScaledScore, setSsScaledScore] = useState('')
  const [savedValue, setSavedValue] = useState<string | null>(null)

  // Load saved value from localStorage on component mount
  useEffect(() => {
    const savedSsScaledScore = localStorage.getItem('ss_scaledScore')
    if (savedSsScaledScore) {
      setSsScaledScore(savedSsScaledScore)
      setSavedValue(savedSsScaledScore)
    }
  }, [])

  const handleSave = () => {
    if (!ssScaledScore) {
      alert("Please enter a SS scaled score.")
      return
    }
    // Save to localStorage
    localStorage.setItem('ss_scaledScore', ssScaledScore)
    setSavedValue(ssScaledScore)
  }
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 py-12">
      <div className="px-6">
        ...
        <section className="mb-8 border-b border-gray-200 dark:border-gray-800 pb-6">
          ...
          <a 
            href="https://cognitivemetrics.com/test/CAIT_SS" 
            target="_blank" 
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-6 text-gray-900 dark:text-gray-100">Enter The Scaled Score Returned at the Bottom:</h2>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 space-y-6">
            <div>
              ...
              <input
                type="number"
                value={ssScaledScore}
                onChange={(e) => setSsScaledScore(e.target.value)}
                ...
                placeholder="Enter SS scaled score"
              />
            </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-300 dark:border-gray-700">
                ...
                <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 rounded">
                  <p className="text-sm text-gray-700 dark:text-gray-300">
                    <strong>Note:</strong> Please save your SS scaled score, this is important for later
                  </p>
                </div>
              </div>
            )}
